...
abstract class elFinderVolumeDriver {
	...
	public function mount(array $opts) {
		...
		$this->defaults = array(
			...
			'write'   => isset($this->options['defaults']['write']) ? !!$this->options['defaults']['write'] : false,
			'locked'  => true,
			'hidden'  => false
		);
